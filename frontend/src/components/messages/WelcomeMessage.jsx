...
const WelcomeMessage = ({ onQuickAction }) => {
  return (
    <div className="flex gap-2 md:gap-3 mb-4 md:mb-5 animate-[slideIn_0.3s_ease-out]">
      ...
      <div className="max-w-[90%] md:max-w-[85%]">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200/50 rounded-[18px_18px_18px_4px] md:rounded-[20px_20px_20px_4px] p-4 md:p-5 shadow-[0_4px_16px_rgba(37,99,235,0.08)]">
        ...
        <div className="flex flex-wrap gap-2 md:gap-3 mt-3 md:mt-4">
          <QuickActionButton
            ...
            label="Search Advil"
            onClick={() => onQuickAction('Advil 200mg')}
          />
